...
@pytest.mark.parametrize(
    ...
    [
        ...
        (test_data, "2023-10-08", result_date_2),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (test_data_df, "Фастфуд", "2023-10-10", result_2),
        (test_data_df, "Яблоко", "2023-10-30", []),
        (test_data_df, "Каршеринг", "2024-10-30", []),
    ],
)
def test_spent_by_category(data, category, date, expected):
    result = spent_by_category(data, category, date).to_dict(orient="records")
